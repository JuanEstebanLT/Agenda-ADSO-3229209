...
// CLASE 13
// Se agrega React Router con rutas protegidas.
// La agenda completa queda detrás de ProtectedRoute.
      ...
      <header className="border-b border-slate-800 bg-slate-950/60 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* CLASE 13: Botón de cerrar sesión */}
            <button
              onClick={logout}
              className="text-xs px-3 py-1.5 rounded-xl bg-red-600 hover:bg-red-700 text-white"
            >
              Cerrar sesión
            </button>
          </div>
            ...
            <header className="mb-5 flex items-start justify-between gap-3">
              <div>
                ...
                <div className="mt-3 inline-flex items-center gap-2 rounded-full bg-purple-50 px-3 py-1 border border-purple-100">
                  <span className="h-2 w-2 rounded-full bg-green-500" />
                  <span className="text-xs font-medium text-purple-800">
                    Conectado · {contactos.length} contacto
                    {contactos.length !== 1 && "s"}
                  </span>
                </div>
              </div>
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Ruta protegida: agenda completa */}
        <Route
          path="/"
          element={
            <ProtectedRoute>
